...
def nzseel1():
    ...
    rheader = s3db.building_nzseel1_rheader
...
def nzseel2():
    ...
    rheader = s3db.building_nzseel2_rheader
...
def adminLevel():
    ...
    tableNZ1 = s3db.building_nzseel1
